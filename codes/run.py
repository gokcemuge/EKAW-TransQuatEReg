...
def parse_args(args=None):
    ...
    parser.add_argument('--loss', default='quate') #uncertain_loss
...
def train_model(init_step, valid_triples, all_true_triples, kge_model, adv_model, train_iterator, rule_iterators, args,
    ...
    if args.opt == 'adam':
        ...
        raise ValueError('optimizer %s not supported ' % args.opt)
...
def manual_argument_pass(args):
    args.batch_size = 512
    args.cuda = True
    args.data_path = '/home/mahfuzmr/PycharmProjects/KGE_Pattern-master/data/SD2020'
    args.do_grid = True
    args.do_valid = True
    ...
    parallel = False
    args.save_path = 'models/RotatE_SD2020_0'
    test_batch_size = 16
